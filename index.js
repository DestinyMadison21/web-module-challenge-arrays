...
function is31Flavors(arrayCheck) {
if (arrayCheck.length === originalFlavors.length){
    return true;
} else {
    return false;
}
...
function addFlavor(){
 let newFlavor = originalFlavor.unshift("Rainbow Sherbert");
 return newFlavor;
